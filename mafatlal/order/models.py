...
class TblOrder(models.Model):
    ...
    order_details = models.CharField(max_length=500, blank=True, null=True)
    size_available = models.CharField(max_length=250, blank=True, null=True)
    ...
    delievery_district = models.CharField(max_length=255, blank=True, null=True)
    delievery_city = models.CharField(max_length=255, blank=True, null=True)
